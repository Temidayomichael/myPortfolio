		...
		const request = mailjet.post('send', { version: 'v3.1' }).request({
			Messages: [
				{
					...
					Subject: 'Job form - Portfolio Website.',
					TextPart: 'Job form - Portfolio Website.',
		    ...
		    <body>
		      <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">
		            ...
		            <p>Message:</p>
		            <p>Company Name : ${req.body.company_name}</p>
		            <p>Product Type : ${req.body.product_type}</p>
		            <p>Employment Type${req.body.emp_type}</p>
		            <p>Payment: ${req.body.payment}</p>
		            <p>Job Description : ${req.body.desc}</p>
		            <br>
		            </div>
		            <h2>O T M .</h2>
